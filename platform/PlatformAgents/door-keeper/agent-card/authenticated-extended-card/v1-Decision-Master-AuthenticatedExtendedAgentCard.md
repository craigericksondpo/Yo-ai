...
*/
{
  ...
  "version": "1.0.0",
  "documentationUrl": "https://privacyportfolio.com/agent-registry/decision-master/auth/v1-Decision-Master-AuthenticatedExtendedAgentCard.md",
  "capabilities": {
    "streaming": true,
  ...
  "x-artifacts": [
    ...
    },
    {
      ...
      "provider": {
        "name": "decision-diary-event",
        "brand": "Yo-ai",
        "product": "Decision-Diary Event Publisher",
        "version": "1.0.0",
        "license": "Yo-ai Internal",
        "url": "https://yo-ai.ai/docs/decision-diary-event",
        "config": {
    ...
    },
    {
      ...
      "provider": {
        ...
        "version": "1.0.0",
        "license": "Yo-ai Internal",
        "url": "https://yo-ai.ai/docs/decision-event-collector",
        "config": {
          "backend": "KafkaPublisher"
        }
      },
