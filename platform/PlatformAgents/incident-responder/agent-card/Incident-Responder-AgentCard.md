...
*/
{
    ...
    "version": "1.0.0",
    "documentationUrl": "https://privacyportfolio.com/agent-registry/incident-responder/Incident-Responder-AgentCard.md",
    "capabilities": {
        "streaming": true,
    ...
    "skills": [
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Handle.Exception.Input" },
            "outputSchema": { "$ref": "#/schemas/Handle.Exception.Output" }
        }
    ],
