...
*/
{
  ...
  "version": "1.0.0",
  "documentationUrl": "https://privacyportfolio.com/agent-registry/auth/v1-The-Sentinel-AuthenticatedExtendedAgentCard.md",
  "capabilities": {
    "streaming": true,
  ...
  "skills": [
     {
      ...
      "inputSchema": {
        ...
        "properties": {
          "log_ref": {
            "type": "string",
            "description": "Log record of adverseEvent."
          },
          "operation": {
            "type": "string"            ]
          },
