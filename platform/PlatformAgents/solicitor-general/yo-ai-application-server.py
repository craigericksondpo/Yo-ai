...
class FastA2A(Starlette):
    ...
    def __init__(
        ...
        *,
        ...
        broker: Broker,
        # Agent card
        name: str | None = "Solicitor-General",
        url: str = 'http://localhost:8000',
        version: str = '1.0.0',
        description: str | None = "Agent that logs all platform events and correlates requests with responses for routing.",
        provider: AgentProvider | None = None,
        # "provider": {"organization": "PrivacyPortfolio", "url": "https://privacyportfolio.com"},
    ...
    },
    {
      ...
      "outputModes": [
        ...
        docs_url: str | None = 'https://privacyportfolio.com/agent-registry/solicitor-general/solicitor-general-agent-doc.md',
        # Starlette
        debug: bool = True,
