...
*/
{
  ...
  "version": "1.0.0",
  "documentationUrl": "https://privacyportfolio.com/agent-registry/workflow-builder/auth/v1-Workflow-Builder-AuthenticatedExtendedAgentCard.md",
  "capabilities": {
    "streaming": true,
  ...
  "skills": [
     {
      ...
      "inputSchema": {
        ...
        "required": ["request_ref", "registration_identifier_ref", "nodes"]
      },
      "outputSchema": {
        "type": "object",
        "properties": {
