# solicitor_general_handler.py

"""
AI‑first AWS Lambda handler for the Solicitor-General agent.
...
from solicitor_general import SolicitorGeneral
