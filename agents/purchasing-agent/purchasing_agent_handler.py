# purchasing_agent_handler.py

"""
AI‑first AWS Lambda handler for the Purchasing-Agent agent.
...
from purchasing_agent import PurchasingAgentAgent
