...
*/
{
  ...
  "version": "1.0.0",
  "documentationUrl": "https://privacyportfolio.com/agent-registry/complaint-manager/auth/v1-Complaint-Manager-AuthenticatedExtendedAgentCard.md",
  "capabilities": {
    "streaming": true,
  ...
  "defaultOutputModes": ["application/json", "text/plain"],
    "skills": [
    {
      "id": "discoverLiability",
      "name": "discoverLiability",
    ...
    },
    {
      ...
      "inputSchema": {
        ...
        "properties": {
          "org_ref": { "type": "string" },
          "liability_findings": { "type": "array", "items": { "type": "string" } },
          "facts": { "type": "object" },
      ...
      "outputSchema": {
        ...
        "properties": {
          ...
          "complaint_document": { "type": "object" }
        }
      }
    },
    {
      ...
      "inputSchema": {
        ...
        "required": ["complaint_id", "enforcement_agency"]
      },
      "outputSchema": {
        "type": "object",
        "properties": {
    ...
    {
      "id": "getEnforcementAgency",
      "name": "getEnforcementAgency",
    ...
    },
    {
      ...
      "inputSchema": {
        ...
        "required": ["stakeholder", "complaint_id"]
      },
      "outputSchema": {
        "type": "object",
        "properties": {
