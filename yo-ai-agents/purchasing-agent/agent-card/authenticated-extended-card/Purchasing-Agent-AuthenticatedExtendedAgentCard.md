...
*/
{
    ...
    "x-artifacts": [
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Purchase-Options.Recommend.Input" },
            "outputSchema": { "$ref": "#/schemas/Purchase-Options.Recommend.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Purchase-Options.Recommend",
        ...
        },
        {
            ...
            "schema": { "$ref": "#/schemas/Purchase-Options.Recommend#/definitions/Input" },
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-Options.Recommend#/definitions/Output" },
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Purchase-Risk.Evaluate.Input" },
            "outputSchema": { "$ref": "#/schemas/Purchase-Risk.Evaluate.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Purchase-Risk.Evaluate",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-Risk.Evaluate#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-Risk.Evaluate#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Purchase-History.Generate",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Purchase-History.Generate.Input" },
            "outputSchema": { "$ref": "#/schemas/Purchase-History.Generate.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Purchase-History.Generate",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-History.Generate#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-History.Generate#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Purchase-Receipt.Generate",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Purchase-Receipt.Generate.Input" },
            "outputSchema": { "$ref": "#/schemas/Purchase-Receipt.Generate.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Purchase-Receipt.Generate",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-Receipt.Generate#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-Receipt.Generate#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Purchase-Issues.Resolve",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Purchase-Issues.Resolve.Input" },
            "outputSchema": { "$ref": "#/schemas/Purchase-Issues.Resolve.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Purchase-Issues.Resolve",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-Issues.Resolve#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-Issues.Resolve#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Return-Or-Refund.Initiate",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Return-Or-Refund.Initiate.Input" },
            "outputSchema": { "$ref": "#/schemas/Return-Or-Refund.Initiate.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Return-Or-Refund.Initiate",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Return-Or-Refund.Initiate#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Return-Or-Refund.Initiate#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Order-Status.Track",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Order-Status.Track.Input" },
            "outputSchema": { "$ref": "#/schemas/Order-Status.Track.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Order-Status.Track",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Order-Status.Track#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Order-Status.Track#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Budget-After-Purchase.Update",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Budget-After-Purchase.Update.Input" },
            "outputSchema": { "$ref": "#/schemas/Budget-After-Purchase.Update.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Budget-After-Purchase.Update",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Budget-After-Purchase.Update#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Budget-After-Purchase.Update#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Transaction-Complete.Verify",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Transaction-Complete.Verify.Input" },
            "outputSchema": { "$ref": "#/schemas/Transaction-Complete.Verify.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Transaction-Complete.Verify",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Transaction-Complete.Verify#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Transaction-Complete.Verify#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Purchase.Initiate",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Purchase.Initiate.Input" },
            "outputSchema": { "$ref": "#/schemas/Purchase.Initiate.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Purchase.Initiate",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase.Initiate#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase.Initiate#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Purchase-Eligibility.Validate",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Purchase-Eligibility.Validate.Input" },
            "outputSchema": { "$ref": "#/schemas/Purchase-Eligibility.Validate.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Purchase-Eligibility.Validate",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-Eligibility.Validate#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-Eligibility.Validate#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Budget.Check",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Budget.Check.Input" },
            "outputSchema": { "$ref": "#/schemas/Budget.Check.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Budget.Check",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Budget.Check#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Budget.Check#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Purchase-History-Report.Run-Task.Input" },
            "outputSchema": { "$ref": "#/schemas/Purchase-History-Report.Run-Task.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Purchase-History-Report.Run-Task",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-History-Report.Run-Task#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Purchase-History-Report.Run-Task#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/AP2-Refund-Flow.Run-Task.Input" },
            "outputSchema": { "$ref": "#/schemas/AP2-Refund-Flow.Run-Task.Output" },
            "auth": "apiKey"
        },
        {
            "name": "AP2-Refund-Flow.Run-Task",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/AP2-Refund-Flow.Run-Task#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/AP2-Refund-Flow.Run-Task#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/AP2-Purchase-Flow.Run-Task.Input" },
            "outputSchema": { "$ref": "#/schemas/AP2-Purchase-Flow.Run-Task.Output" },
            "auth": "apiKey"
        },
        {
            "name": "AP2-Purchase-Flow.Run-Task",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/AP2-Purchase-Flow.Run-Task#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/AP2-Purchase-Flow.Run-Task#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Order-Tracking-Adapter.Input" },
            "outputSchema": { "$ref": "#/schemas/Order-Tracking-Adapter.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Order-Tracking-Adapter",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Order-Tracking-Adapter#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Order-Tracking-Adapter#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Risk-Engine",
            ...
            "inputSchema": { "$ref": "#/schemas/Risk-Engine.Input" },
            "outputSchema": { "$ref": "#/schemas/Risk-Engine.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Risk-Engine",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Risk-Engine#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Risk-Engine#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Budget-Engine",
            ...
            "inputSchema": { "$ref": "#/schemas/Budget-Engine.Input" },
            "outputSchema": { "$ref": "#/schemas/Budget-Engine.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Budget-Engine",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Budget-Engine#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Budget-Engine#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "AP2.Client",
            ...
            "inputSchema": { "$ref": "#/schemas/AP2.Client.Input" },
            "outputSchema": { "$ref": "#/schemas/AP2.Client.Output" },
            "auth": "apiKey"
        },
        {
            "name": "AP2.Client",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/AP2.Client#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/AP2.Client#/definitions/Output" },
            "description": "Output schema for ."
        }
    ],
