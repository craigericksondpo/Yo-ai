/**
 * This IP-Inspector AuthenticatedExtendedCard conveys:
...
/**
* IP-Inspector Authenticated Extended Agent Card¶
*/
{
  "name": "IP-Inspector",
  "description": "Discovers intellectual property and potential use cases, and searches for implementation instances.",
  "url": "https://privacyportfolio.com/agent-registry/ip-inspector/auth/agent.json",
  "provider": {
  ...
  "version": "1.0.0",
  "documentationUrl": "https://privacyportfolio.com/agent-registry/ip-inspector/auth/v1-IP-Inspector-AuthenticatedExtendedAgentCard.md",
  "capabilities": {
    "streaming": true,
  ...
  "x-tasks": [
    {
      ...
      "description": "Runs a full discovery pipeline to identify IP assets and map them to products.",
      "produces": ["ipPortfolio", "implementationMap", "evidenceManifest"]
    },
    {
      "name": "ip-report-task",
      "description": "Generates a regulator-friendly IP report with provenance, inferred use cases, and strategic insights.",
      "produces": ["ipReport", "useCaseAnalysis", "riskSummary"]
    }
  ],
  "x-tools": [
    {
      "name": "portfolio-clustering-engine",
      "description": "Internal engine for clustering patents, trademarks, and related IP into strategic themes."
    },
    {
      "name": "implementation-scanner",
      "description": "Searches SDKs, APIs, documentation, and product materials for implementation instances."
    },
    {
      "name": "ip-provenance-tracker",
      "description": "Resolves ownership history, assignments, and corporate lineage."
    }
  ],
  "x-messages": [
    {
      "name": "ip-discovery-complete",
      "description": "Signals that IP discovery and mapping have completed."
    },
    {
      "name": "ip-report-ready",
      "description": "Push notification when an IP report is generated."
    }
  ],
  "x-artifacts": [
    {
      "name": "ip-portfolio",
      "description": "Structured list of discovered IP assets with metadata and provenance."
    },
    {
      "name": "implementation-map",
      "description": "Mapping of IP assets to products, services, and technical implementations."
    },
    {
      "name": "ip-report",
      "description": "Human-readable and machine-readable report summarizing IP posture and strategic insights."
    }
  ],
