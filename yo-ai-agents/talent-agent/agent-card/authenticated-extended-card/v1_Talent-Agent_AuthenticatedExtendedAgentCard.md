...
*/
{
  ...
  "version": "1.0.0",
  "documentationUrl": "https://privacyportfolio.com/agent-registry/talent-agent/auth/v1-Talent-Agent-AuthenticatedExtendedAgentCard.md",
  "capabilities": {
    "streaming": true,
  ...
  "skills": [
    {
      "id": "scan-job-postings",
      "name": "Scan Job Postings",
    ...
    {
      "id": "pitch-consulting",
      "name": "Pitch Consulting Services",
    ...
    {
      "id": "request-talent-profile",
      "name": "Request Talent Profile",
