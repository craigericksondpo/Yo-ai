...
*/
{
    ...
    "x-artifacts": [
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Job-Postings.Scan.Input" },
            "outputSchema": { "$ref": "#/schemas/Job-Postings.Scan.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Job-Postings.Scan",
        ...
        },
        {
            ...
            "schema": { "$ref": "#/schemas/Job-Postings.Scan#/definitions/Input" },
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Job-Postings.Scan#/definitions/Output" },
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Consulting-Services.Pitch.Input" },
            "outputSchema": { "$ref": "#/schemas/Consulting-Services.Pitch.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Consulting-Services.Pitch",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Consulting-Services.Pitch#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Consulting-Services.Pitch#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Application.Submit",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Application.Submit.Input" },
            "outputSchema": { "$ref": "#/schemas/Application.Submit.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Application.Submit",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Application.Submit#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Application.Submit#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Talent-Profile.Request",
        ...
        },
        {
            ...
            "inputSchema": { "$ref": "#/schemas/Talent-Profile.Request.Input" },
            "outputSchema": { "$ref": "#/schemas/Talent-Profile.Request.Output" },
            "auth": "apiKey"
        },
        {
            "name": "Talent-Profile.Request",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Talent-Profile.Request#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Talent-Profile.Request#/definitions/Output" },
            "description": "Output schema for ."
        }
    ],
