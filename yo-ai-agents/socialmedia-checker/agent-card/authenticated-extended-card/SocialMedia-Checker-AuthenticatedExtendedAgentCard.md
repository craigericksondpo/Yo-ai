...
*/
{
    ...
    "x-artifacts": [
        ...
        },
        {
            ...
            "schema": { "$ref": "#/schemas/Promotional-Engagement.Verify#/definitions/Input" },
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Promotional-Engagement.Verify#/definitions/Output" },
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Misappropriation.Detect#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Misappropriation.Detect#/definitions/Output" },
            "description": "Output schema for ."
        },
        {
            "name": "Evidence.Collect",
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Evidence.Collect#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Evidence.Collect#/definitions/Output" },
            "description": "Output schema for ."
        }
    ],
