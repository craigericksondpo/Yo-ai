...
*/
{
    ...
    "x-artifacts": [
        ...
        },
        {
            ...
            "schema": { "$ref": "#/schemas/Compliance-Standard.Get#/definitions/Input" },
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Compliance-Standard.Get#/definitions/Output" },
        ...
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Compliance.Validate#/definitions/Input" },
            "description": "Input schema for ."
        },
        {
            ...
            "version": "1.0.0",
            "artifactType": "messageType",
            "schema": { "$ref": "#/schemas/Compliance.Validate#/definitions/Output" },
            "description": "Output schema for ."
        }
    ],
